...
export default function AboutPage() {
  ...
  const features = [
    {
      ...
      description:
        "Create stunning events in minutes with our intuitive builder and customization options.",
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      description:
        "QR code-based check-in system ensures secure and efficient attendee management.",
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Connect attendees through interactive features and build lasting communities.",
    },
    {
      icon: Zap,
      title: "Lightning Fast",
      description:
        "Built with modern technology for speed, reliability, and exceptional user experience.",
    },
  ];
  ...
  const team = [
    ...
    },
    {
      ...
      description:
        "Designing intuitive experiences that make event management effortless.",
    },
    {
      name: "Michael Rodriguez",
      role: "Lead Engineer",
      description:
        "Building scalable technology that powers millions of events worldwide.",
    },
  ];
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            We're on a mission to make event creation and management accessible
            to everyone, from small community gatherings to large-scale
            conferences.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                EventHub was born from the belief that everyone should have the
                tools to create meaningful connections and unforgettable
                experiences. Whether you're organizing a small workshop or a
                major conference, we provide the technology and support you need
                to succeed.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                We've helped thousands of organizers bring their visions to
                life, connecting millions of people worldwide through the power
                of events.
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 rounded-2xl p-8 h-96 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Every event is an opportunity to bring people together
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We've built everything you need to create, manage, and grow your
              events
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                We strive for excellence in everything we build, ensuring our
                platform meets the highest standards of quality and reliability.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                We believe in the power of community and work to create tools
                that bring people together and foster meaningful connections.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                of the curve and provide cutting-edge event management
                solutions.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-2xl p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                We prioritize security, privacy, and transparency in all our
                interactions, building lasting trust with our community.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Join thousands of event creators who trust EventHub to bring their
            visions to life.
          </p>
          <Button
            size="lg"
