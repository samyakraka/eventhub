...
export function LoginForm({ onSuccess }: LoginFormProps) {
  ...
  const { signIn, signInWithGoogle, sendEmailLink } = useAuth();
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 h-12 border-transparent bg-slate-700/60 text-white focus:border-blue-500 focus:ring-2 focus:ring-purple-500/50 shadow-inner rounded-xl placeholder-gray-300"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 pr-10 h-12 border-transparent bg-slate-700/60 text-white focus:border-blue-500 focus:ring-2 focus:ring-purple-500/50 shadow-inner rounded-xl placeholder-gray-300"
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-black/60 text-gray-300 rounded-full font-medium">
            Or continue with
          </span>
        </div>
      </div>
